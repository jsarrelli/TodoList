...
kubectl config set-context --current --namespace=to-do-list-app
kubectl apply -f kubernetes/akka-cluster.yml
kubectl expose deployment to-do-list-app --type=LoadBalancer --name=to-do-list-app-service
...
POD=$(kubectl get pods | grep to-do-list-app | grep Running | head -n1 | awk '{ print $1 }')
